...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0 torchrun --nnodes=1 --nproc_per_node=1 --master_port=12346 finetune_hf.py  /home/w1nd/darkword/1darkword/data_crawl/darkword_data_chatglm3/  THUDM/chatglm3-6b configs/lora.yaml | tee -a /home/w1nd/darkword/1darkword/model_train/ChatGLM3-6B/darkword-ChatGLM3-6B/train.log
